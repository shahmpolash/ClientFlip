(function ($) {
    ...
    $(document).ready(function () {
      ...
      $(window).on("resize", function () {
        let nw = $(window).width() > 991 ? "lg" : "sm";
        if (nw !== w) {
          window.location.reload();
        }
      });
      $(document).on("click", ".userDashLink", function (e) {
        let menuButton = $(e.target).closest(".navbar-area");
        menuButton = menuButton.find(".menu");      
      ...
      if ($(window).width() < 992) {
        ...
        $(".menu-item-has-children a").on("click", function (e) {
          ...
          const otherSubMenus = $(".menu-item-has-children .sub-menu").not(
            clickedSubMenu
          );
      ...
      if ($(window).width() > 991) {
        $(".menu-item-has-children").on(
          "click",
          /* eslint-disable-line no-undef */ menuLinkClickHandler
        );
        ...
        if ($(".dropdown-menu-btn").length) {
          ...
          $("body").on("click", function (event) {
            if (
              ...
              !$(event.target).closest(".dkt-sitebar-menu").length
            ) {
              $(".dkt-sitebar-menu").removeClass("navbar-nav-show");
            }
            if (
